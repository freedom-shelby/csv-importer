...
class Report
{
    ...
    const MERCHANT_COL_NAMES = ['id', 'name'];
    const BATCH_COL_NAMES = ['id', 'merchant_id', 'batch_date', 'batch_ref_num'];
    const TRANSACTION_COL_NAMES = ['batch_id', 'trans_date', 'trans_type', 'trans_card_type', 'trans_card_num', 'trans_amount'];
}
